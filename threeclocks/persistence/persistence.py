...
from threeclocks.persistence.persistence_pc import (
    load_game_pc_data,
    persist_game_pc_data,
    )
from threeclocks.persistence.persistence_items import (
    load_game_items_data,
    persist_game_items_data,
    )
from threeclocks.ui.ui_main_utils.ui_main_utils import create_error_dialog_msg
from threeclocks.persistence.persistence_utils import save_data_to_file
...
def clear_all_persisted_data():
    ...
    _clear_persisted_data_file(
        settings['can_continue_game_file'], 'can_continue_game')
...
def load_game_data(game):
    ...
    try:
        ...
        create_error_dialog_msg(
            game.ui_manager.ui_main_menu, f"{log_error_msg}:\n{e}")
        return
